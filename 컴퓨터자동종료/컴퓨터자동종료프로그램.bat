<# : Batch portion 
title Auto Shutdonw Program // by codingmee
@echo off & setlocal enabledelayedexpansion

set "menu[0]=making a shutdown reservation :"
set "menu[1]=cancel shutdown revervation"
set "menu[2]=shutdown this program"
...
:1
set /p time=Enter time(sec) you want to turn off : 
